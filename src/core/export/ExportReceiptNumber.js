...
var wscols = [
  ...
  { wch: 8 }, // cod value
  { wch: 13 }, // good value
  { wch: 13 }, // shipping charge
  { wch: 8 }, // discount
  { wch: 8 }, // tax
  { wch: 10 }, // adjustment
  { wch: 10 }, // total
  { wch: 15 }, // sub total amount
  { wch: 15 }, // total amount
  { wch: 15 }, // cod fee percentage
  { wch: 12 }, // cod fee value
  { wch: 12 }, // receive amount
  { wch: 5 }, // tenant id
  { wch: 15 }, // courier channel id
  { wch: 15 }, // documents number
  { wch: 25 }, // upload date
];

export default class ExportReceiptNumber extends React.Component {
